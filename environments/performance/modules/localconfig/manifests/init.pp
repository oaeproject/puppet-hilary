class localconfig {
  ...
  # App servers
  $app_hosts_internal = ['10.112.4.121', '10.112.4.122', '10.112.5.18', '10.112.4.244']
  $app_hosts_external = ['165.225.133.113', '165.225.133.114', '165.225.136.163', '165.225.136.47']
