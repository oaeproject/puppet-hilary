...
node 'bastion' inherits linuxnode {
  ...
  firewall { '001 route web :80 traffic to web0':
    chain     => 'PREROUTING',
    table     => 'nat',
    iniface   => 'eth0',
    proto     => 'tcp',
  ...
  firewall { '001 rate limit new forwarded web connections':
    chain     => 'FORWARD',
    iniface   => 'eth0',
    proto     => 'tcp',
    state     => 'NEW',
  ...
  firewall { '001 rate limit established forwarded web connections':
    chain     => 'FORWARD',
    iniface   => 'eth0',
    proto     => 'tcp',
